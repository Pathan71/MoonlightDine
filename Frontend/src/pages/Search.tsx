...
export default function Search() {
    ...
    const pricesSelected = searchParams
        .getAll("priceRange")
        .map(Number);
    ...
    const handlePriceToggle = (price: number) => {
        ...
        if (current.includes(price)) {
            ...
            updated.forEach((u) => nextParams.append("priceRange", u.toString()));
        } else {
            nextParams.append("priceRange", price.toString());
        }
        setSearchParams(nextParams);
    };
                    ...
                    <div className="sticky top-44 space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-4 gap-1.5">
                                {priceOptions.map((p) => {
                                    const active = pricesSelected.includes(p.value);
